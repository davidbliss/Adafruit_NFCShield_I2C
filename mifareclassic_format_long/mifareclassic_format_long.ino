...
/*! 
    ...
    card for NDEF Records and writes an NDEF MIME Record 
...
uint8_t url[ ] = "blog.totango.com/2012/07/how-i-learnt-to-tell-my-company-story-by-participating-in-crmidol/";
...
//  write a ndef long with the defined url
